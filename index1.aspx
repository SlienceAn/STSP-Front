...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script>
     ...
     <script>
		...
		.overflowToShow { overflow:scroll }
                  ...
                  <div id="divMaskFrame" style="background-color: #CCCCCC; display: none; left: 0px;
                    position: absolute; top: 0px;">
                                                    ...
                                                    <a>
                                                        ...
                                                        <asp:Panel ID="Panel1" runat="server" class="map" style="background: url(image/index/map_v6.svg) no-repeat center;z-index: -3;background-size:100%;background-color:#fff7d7;border-width:5px;border-color:#333333" OnClick="document.getElementById('ContentPlaceHolder1_Button4').click();" title="點擊放大">                      
                                                           ...
                                                           <p style="margin-bottom:0px;font-size:14px;color:black;position: relative;" class="note1"> 點我放大</p>
                                                            <asp:Image ID="site3" runat="server" Style=" z-index: 0; position: relative;display:block"
											...
											<div class="col-md-6">
												...
												<div class="TwoShot overflowToShow" style="height:570px;">
												<!--	<div class="littleShot">
													...
													<div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6 disappear" style="padding-left:0px">
                                                                    <table class="table">
                                                                        <tr><td style="border-top:none">懸浮微粒</td><td style="border-top:none"> <asp:Literal ID="data3_1" runat="server"></asp:Literal>μg/m<sup>3</sup></td></tr>
                                                                        <tr><td>二氧化硫</td><td><asp:Literal ID="data3_2" runat="server"></asp:Literal>ppb</td></tr>
                                                                        <tr><td>一氧化碳</td><td><asp:Literal ID="data3_3" runat="server"></asp:Literal>ppm</td></tr>
                                                                        <tr><td>臭氧</td><td><asp:Literal ID="data3_4" runat="server"></asp:Literal>ppb</td></tr>
                                                                        <tr><td>二氧化氮</td><td><asp:Literal ID="data3_5" runat="server"></asp:Literal>ppb</td></tr>
                                                                        <tr><td>細懸浮微粒</td><td><asp:Literal ID="data3_6" runat="server"></asp:Literal>μg/m<sup>3</sup></td></tr>
                                                                    </table>
                                                                </div>	
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6 disappear" style="padding-left:0px">
                                                                    <table class="table">
                                                                        <tr><td style="border-top:none">懸浮微粒</td><td style="border-top:none"> <asp:Literal ID="data4_1" runat="server"></asp:Literal>μg/m<sup>3</sup></td></tr>
                                                                        <tr><td>二氧化硫</td><td><asp:Literal ID="data4_2" runat="server"></asp:Literal>ppb</td></tr>
                                                                        <tr><td>一氧化碳</td><td><asp:Literal ID="data4_3" runat="server"></asp:Literal>ppm</td></tr>
                                                                        <tr><td>臭氧</td><td><asp:Literal ID="data4_4" runat="server"></asp:Literal>ppb</td></tr>
                                                                        <tr><td>二氧化氮</td><td><asp:Literal ID="data4_5" runat="server"></asp:Literal>ppb</td></tr>
                                                                        <tr><td>細懸浮微粒</td><td><asp:Literal ID="data4_6" runat="server"></asp:Literal>μg/m<sup>3</sup></td></tr>
                                                                    </table>
                                                            </div>
                                                            </div>	
                                                        </div>
