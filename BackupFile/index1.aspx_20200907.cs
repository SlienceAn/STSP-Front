     ...
     //   item1.Text = "XXX";
        ...
        using (SqlConnection cn = new SqlConnection(sin))
        {
            ...
            sql1 = @"select top 5  [Station_ID]
                           ,[Station]
                           ,[AQI_Item]
                           ,[AQI_Value],[Date_Time] from AQI_Log_Report  order by Date_Time desc ";
            ...
            while (dr.Read())
            {
                ...
                if(dr["Station_ID"].ToString()=="A0"+i)
                {
                    ...
                    System.Web.UI.WebControls.Image site = (System.Web.UI.WebControls.Image)Panel2.FindControl("site" + i);
                    System.Web.UI.WebControls.Image site2 = (System.Web.UI.WebControls.Image)Panel2.FindControl("site" + i + "_1");
        ...
        using (SqlConnection cn = new SqlConnection(sin))
        {
            ...
            sql1 = @"select top 5  [SiteName]
                                  ...
                                  ,[Datatime]
                                  ,[WS_Value]
                                  ,[WD_Value] from vBbackward  order by Dataday desc,Datatime desc ";
        ...
        using (SqlConnection cn = new SqlConnection(sin))
        {
            ...
            sql1 = @"SELECT TOP 4 [Date_Time]
                                  ...
                                  ,[Station]
                                  ,[PM25_Value]
                              FROM [PM25_Log_Report] order by Date_Time desc ";
