    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        '一般測站
            ...
            If rd.Read Then
                ...
                StationName.Text = rd.Item("STname_TW") 
                ...
                If HasTable = True And HasUpdate = True Then 'data update
                    ...
                    Dim DP_choice As String = "D01"

                        ol = "<ol Class='breadcrumb'>"
                        ol &= OptionList("breadcrumb_station.aspx", "測站資料", "ST=" & st & "&d1=" & rDate1 & "&d2=" & rDate2)
                        ...
                        sdata.Text = "<iframe id='ifs' style='border:none;width:100%;height:950px' src='breadcrumb_station.aspx?ST=" & st & "' scrolling=no></iframe>"
                    Else
                        sdata.Text = "目前無資料"
					End If
            End If
