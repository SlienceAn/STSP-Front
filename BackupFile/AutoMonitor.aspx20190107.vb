        ...
        Cmd.CommandText = "Select * from STSP_station where stname='" & st & "'"
            ...
            If HasTable = True And HasUpdate = True Then 'data update
                ...
                If Request("ch") = 2 Then
                    sdata.Text = "<iframe id='ifs' style='border:none;width:100%;' src='breadcrumb_chart.aspx?ST=" & st & "&DP_NO=" & DP_choice & "&d1=" & start_time & "&d2=" & end_time & "&tt=" & tt & "&c=0&col=" & dCol & "&line=" & dLine & "'  scrolling=no></iframe>"
                Else
