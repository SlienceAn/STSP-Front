    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Cmd.CommandText = "Select * from STSP_station where stname='" & st & "'"
            ...
            If HasTable = True And HasUpdate = True Then 'data update
                ...
                ol &= OptionList("breadcrumb_chart.aspx", "圖表", "ST=" & st & "&d1=" & start_time & "&d2=" & end_time & "&DP_NO=" & DP_choice & "&tt=t60&c=0&col=" & dCol & "&line=" & dLine)
                ...
                If Request("ch") = 2 Then
                    sdata.Text = "<iframe id='ifs' style='border:none;width:100%;height:1500px;' src='breadcrumb_chart.aspx?ST=" & st & "&d1=" & start_time & "&d2=" & end_time & "&DP_NO=" & DP_choice & "&tt=t60&c=0&col=" & dCol & "&line=" & dLine & "'  scrolling=no></iframe>"
                Else
                    sdata.Text = "<iframe id='ifs' style='border:none;width:100%;height:1500px;' src='breadcrumb_station.aspx?ST=" & st & "&DP_NO=" & DP_choice & "'  scrolling=no></iframe>" 'height:950px
                End If
            Else
                sdata.Text = "目前無資料"
					End If
