<%@ Page Language="VB" AutoEventWireup="false" CodeFile="breadcrumb_table.aspx.vb" Inherits="breadcrumb_table" %>
...
<head runat="server">
    ...
    <%-- link href="work_data/jquery-ui.css" rel="stylesheet" / --%>
    ...
    <%-- script src="work_data/jquery-2.1.1.min.js"></script --%>
	...
	<%-- script src="https://cdnjs.cloudflare.com/ajax/libs/free-jqgrid/4.15.4/jquery.jqgrid.min.js" integrity="sha256-GN28v8v0UEhIeH35OHeGh9LoP5liiKMRbiIFVQ5flTo=" crossorigin="anonymous"></script --%>
	<%-- script src="https://cdnjs.cloudflare.com/ajax/libs/jqgrid/4.6.0/js/i18n/grid.locale-tw.js" integrity="sha256-gZRn1VFNUC3z1adGxoyvSr2X2RJkQ8SqtXvhlN7nbvw=" crossorigin="anonymous"></script --%>
...
<body <%--onload="startLoad()"--%>>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <div class="row white-bg" style="padding: 0 0 20px 0;">
                    <div class="col-lg-12">
                        ...
                        <asp:DropDownList ID="DP_NO" runat="server" style="width:70px;height:26px;" Visible="False"></asp:DropDownList>
                        <!--Custom!-->
                        ...
                        <asp:DropDownList ID="D_ChartType" runat="server"  Visible="false">
 ...
 <!--    <div id="Right_group"style="position:absolute; top:10px; right:10px;">
        <div class="btn-group">
            <button id="Btn_download" data-toggle="dropdown" class="btn btn-outline btn-warning dropdown-toggle">下載 <span class="caret"></span></button>
            <ul id="ul_download" class="dropdown-menu" style="padding:2px 0;right:0; left:inherit; min-width:100px;" >
                <li><asp:LinkButton ID="Export_xls" runat="server">Excel</asp:LinkButton></li>
                <li><asp:LinkButton ID="Export_csv" runat="server">CSV</asp:LinkButton></li>
            </ul>
        </div>
    ...
    <%-- trirand:JQGrid runat="server" ID="JQGrid2" AutoWidth="True" Height="500"  style="width:100%; " --%>
        <%-- Columns--%><%--/Columns --%>         
        <%-- AppearanceSettings ShowRowNumbers="True" HighlightRowsOnHover="True" RowNumbersColumnWidth="40"   /--%>
        <%-- ExportSettings ExportDataRange="All" / --%>  
        <%-- PagerSettings PageSize="100" /--%>
    <%-- /trirand:JQGrid>  --%>

    <asp:gridview id="JQGrid2" Height="500"  style="width:100%;"
...
<script>
     ...
     <script>
         ...
         function MaxSize() {
             $("#JQGrid2").jqGrid('setGridWidth', $(window).width() - 55, true);
             $("#JQGrid2").jqGrid('setGridHeight', $(window).height() - 180, true);
         ...
         function NormalSize() {
             $("#JQGrid2").jqGrid('setGridWidth', $(window).width() - 20, true);
             $("#JQGrid2").jqGrid('setGridHeight', "500px", true);
         ...
         function SearchData() {
             ...
             switch (dPage) {
                 ...
                 case "breadcrumb_table":
                     ...
                     //alert(url)
                     //var url_par = url.toString.split('?')[1]
                     
                     ReUrl += "&tt=" + document.getElementById("TableTime").value;

                     //ReUrl += "&DP_NO=" + document.getElementById("DP_NO").value + '';
                     ReUrl += "&col=";
                 ...
                 case "jChart":
                     alert(9)
                     ReUrl += "&tt=" + document.getElementById("CP_TableTime").value;
                     ReUrl += "&c=" + document.getElementById("CP_D_ChartType").value;
                     var col = "&col=";
                     var line = "&line=";
                     var n = 0;
                     while (true) {
