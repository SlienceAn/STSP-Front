<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="MeetingData_Download.aspx.cs" Inherits="index_MeetingData_Download" %>
    ...
    <link href="css/CTSP_Login_Style.css" rel="stylesheet" type="text/css" />
        <style type="text/css">
            ...
            .table-bordered > tbody > tr > th, .table-bordered > tbody > tr > td {
                ...
                .table-bordered > tbody > tr > td:nth-child(1), .table-bordered > tbody > tr > td:nth-child(3) {
                    text-align: center;
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div class="resultsBox"><%--form-group row--%>
         ...
         <asp:Panel runat="server" ID="PL1" class="areaBtn"></asp:Panel><%--col-sm-9--%>
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
              ...
              SelectCommand="SELECT DISTINCT  DATEPART(year,[time] )  as  [time] FROM [MeetingData] where dele=0 ">
          </asp:SqlDataSource>
                       </div>
        </div>
        ...
        DataKeyNames="meeting_id" DataSourceID="SqlDataSource1" width="90%" cellpadding="0" 
               OnRowCreated="GridView1_RowCreated"   OnSorting="GridView1_Sorting" ondatabound="GridView1_DataBound"  OnPageIndexChanging="GridView1_PageIndexChanging" 
    ...
    <asp:BoundField DataField="time" HeaderText="時間"  SortExpression="time" >
        ...
        <asp:BoundField DataField="abstract" HeaderText="摘要" SortExpression="abstract" Visible="False">
        <HeaderStyle Font-Size="14px" />
        <ItemStyle Font-Size="14px" />
        </asp:BoundField>        
        <asp:TemplateField HeaderText="會議資料下載"  >
          <ItemTemplate>
       <%--   <asp:LinkButton ID="filepath" runat="server" onclick="LinkButton1_Click" CommandName='<%# Bind("filepath") %>'>下載</asp:LinkButton>--%>
    <asp:HyperLink ID="filepath" runat="server" NavigateUrl='<%# "../BackEnd/fundot/"+Eval("filepath") %>'   >下載</asp:HyperLink>
          </ItemTemplate>
        <HeaderStyle Font-Size="14px" />
        <ItemStyle Font-Size="14px" Width="80px" />                     
          </asp:TemplateField>
          ...
          <div id="down" runat="server"  aria-label="Toolbar with button groups" class="pageTool" style="border-color: #C0C0C0;"><%--padding: 10px 0px 10px 90px;--%>
              ...
              <div class="pageBr">   
                ...
                <asp:DropDownList ID="ddlPageSize2" runat="server" AutoPostBack="True" onselectedindexchanged="ddlPageSize_SelectedIndexChanged"  CssClass="drpPage"  style="width: auto">
                    <asp:ListItem >10</asp:ListItem>
                    <asp:ListItem Selected="True">50</asp:ListItem>
                    <asp:ListItem>100</asp:ListItem>
                </asp:DropDownList>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:sin %>" 
        SelectCommand="SELECT DISTINCT [meeting_id], [title],[abstract], CONVERT(VARCHAR(10), [time], 121) as [time],[filepath],[sort] FROM [MeetingData] where dele=0">
    </asp:SqlDataSource>
